...
const ChatPage = () => {
	...
	const { messages, getMessage, subscribeToMessages, unsubscribeFromMessages } = useMessageStore();
	...
	}, [getMyMatches, authUser, getMessage, subscribeToMessages, unsubscribeFromMessages, id]);
